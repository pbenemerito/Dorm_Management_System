  ...
  <form action="" method="post">
   ...
   <label for="Year">Year</label>
    ...
    <select id="Dorm" name="Dorm">
      ...
      <option value="4-5">DORM 4-5 (KAMAGONG RESIDENCE)</option>
      <option value="6-7">DORM 6-7 (DUNGON RESIDENCE)</option>
      <option value="8-9">DORM 8-9 (ACACIA RESIDENCE)</option>
      <option value="10-11">DORM 10-11 (MAHOGANY RESIDENCE)</option>
    </select>
