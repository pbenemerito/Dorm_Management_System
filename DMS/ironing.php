			...
			include "connect.php";
				...
				while($rows=mysqli_fetch_array($result))
				{
					$student_id=$rows['student_id'];
						...
						$abc="SELECT count(*) as c FROM violations WHERE student_id='$student_id'";
						...
						$abc="SELECT count(*) as c FROM renderers WHERE student_id='$student_id' AND status='Cleared'";
						$result=mysqli_query($con,$abc);
						if($result){
							while($row=mysqli_fetch_assoc($result))
							{
						...
						$diff=$demerits-$merits;
						echo "<br><br>
		    			<h1><a href=\"\">Demerits</a></h1>
	    				<br><br>
	    				<p>".$demerits."</p>

	    				<br><br>
	    				<h1><a href=\"\">Merits</a></h1>
	    				<br><br>
	    				<p>".$merits."</p>

	    				<br><br>
	    				<h1><a href=\"\">Total</a></h1>
	    				<br><br>
	    				<p>".$diff."</p>";		
