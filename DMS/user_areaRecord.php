		...
		<?php
			if(isset($_POST['submit']))
			{
				...
				$qry="select * from grade;";
								...
								while($rows=mysqli_fetch_array($result))
								{
									if($room==$rows[6] && $date==$rows['date']){
									echo "<script>window.alert('Room already have grade!')
				...
				$qry .= "INSERT INTO grade (area,grade,room_number,date,seen) values('Frontyard','$grade3',$room','$date', 0 );";
				$qry .= "INSERT INTO grade (area,grade,room_number,date,seen) values('Frontyard','$grade4',$room','$date', 0 );";
				$qry .= "INSERT INTO grade (area,grade,room_number,date,seen) values('Frontyard','$grade5',$room','$date', 0 );";
				$qry .= "INSERT INTO grade (area,grade,room_number,date,seen) values('Frontyard','$grade6',$room','$date', 0 );";
