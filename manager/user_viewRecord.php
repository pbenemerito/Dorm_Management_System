...
<article><br><br>
	...
	<?php 
		...
		<?php 
			...
			if($result) {
				if(mysqli_num_rows($result) > 0) {
					echo "<div id=\"leftnav\"><a href=\"user_lcard.php\"><img src=\"../images/studentreq.png\">&emsp;<font color=\"#ffffff\">LEAVE REQUEST<img src='../images/notif.png'/></a></font></div>";
				} else {
		...
		include 'connect.php';
    		...
    		if($result = mysqli_query($con, $sql)){
        		if(mysqli_num_rows($result) > 0){
					...
					<td>".$rows[5]."</td>
					<td>".$rows[6]."</td>
					<td><button><a href = 'user_edit_student.php?id=".$rows['0']."'><center><img src='../images/up.png'/></a></button>
